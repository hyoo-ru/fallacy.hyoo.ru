...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_fallacy extends $.$hyoo_fallacy {
            ...
            filter() {
                var _a;
                return (_a = this.$.$mol_state_arg.value('filter')) !== null && _a !== void 0 ? _a : '';
            }
            search(next) {
                var _a;
            ...
            content_title(filter) {
                var _a, _b;
                return (_b = (_a = this.tags()[filter]) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : super.title();
            }
            search_focus(event) {
